...
import "./GenerateFromDataLotoFacil.css";

const GenerateFromDataLotoFacil = () => {
  ...
  return (
    <div className="generate-numbers-container">
      <ToastContainer />
      <h1>Gerar Números com Base em Dados - LotoFácil</h1>
...
export default GenerateFromDataLotoFacil;
