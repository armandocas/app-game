...
import "./GenerateSurpriseLotoFacil.css";

const GenerateSurpriseLotoFacil = () => {
  ...
  const generateSurpriseNumbers = () => {
    ...
    const numbers = [];
    while (numbers.length < 15) { // Loto Fácil precisa de 15 números
...
export default GenerateSurpriseLotoFacil;
