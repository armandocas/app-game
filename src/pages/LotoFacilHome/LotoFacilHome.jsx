    ...
    <div>
      ...
      <div className="container-fluid titulo text-center">
        ...
        <div className="row mt-4">
          ...
          <div className="col-md-4 col-sm-6 mb-3">
            <Link to="/app/lotofacil-conjunto" className="btn btn-primary-lotofacil w-100">
              Conjunto
            </Link>
          </div>
          <div className="col-md-4 col-sm-6 mb-3">
          ...
          <div className="col-md-4 col-sm-6 mb-3">
            <Link to="/app/lotofacil/gerar-via-arquivo-numerologia" className="btn btn-primary-lotofacil w-100">
              Gerar Baseado em Numerologia
            </Link>
          </div>
          <div className="col-md-4 col-sm-6 mb-3">
            <Link to="/app/lotofacil/modo-surpresa" className="btn btn-primary-lotofacil w-100">
              Modo Surpresa
            </Link>
          </div>
          <div className="col-md-4 col-sm-6 mb-3">
            <Link to="/app/lotofacil/zodiaco" className="btn btn-primary-lotofacil w-100">
              Zodíaco
            </Link>
          </div>
          <div className="col-md-4 col-sm-6 mb-3">
