    ...
    <div>
      ...
      <div className="container-fluid titulo text-center">
        ...
        <div className="row mt-4">
          ...
          <div className="col-md-4 col-sm-6 mb-3">
            <Link to="/app/megasena/gerar-via-arquivo-balanceados" className="btn btn-primary w-100">
              Gerar balanceados
            </Link>
          </div>
          <div className="col-md-4 col-sm-6 mb-3">
            <Link to="/app/megasena/gerar-via-arquivo-dados" className="btn btn-primary w-100">
              Gerar baseado em dados
            </Link>
          </div>
          <div className="col-md-4 col-sm-6 mb-3">
            <Link to="/app/megasena/gerar-via-arquivo-numerologia" className="btn btn-primary w-100">
          ...
          <div className="col-md-4 col-sm-6 mb-3">
            <Link to="/app/megasena/zodiaco" className="btn btn-primary w-100">
              Zodíaco
            </Link>
          </div>
          <div className="mt-3">
