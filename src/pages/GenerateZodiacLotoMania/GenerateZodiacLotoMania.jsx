...
import "./GenerateZodiacLotoMania.css";
...
const GenerateZodiacLotoMania = () => {
  ...
  return (
    <div className="generate-zodiac-container">
      <ToastContainer />
      <h1>Gerar Números com Base no Zodíaco - LotoMania</h1>
...
export default GenerateZodiacLotoMania;
