...
import './QuinaEstatistica.css';
import { Link } from 'react-router-dom';

function QuinaEstatistica() {
          ...
          .map((linha) =>
            linha
              ...
              .map((numero) => {
                ...
                return !isNaN(valor) && valor >= 1 && valor <= 80 ? valor : null;
              })
...
export default QuinaEstatistica;
