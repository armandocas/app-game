...
import './DuplaSenaEstatistica.css';
import { Link } from 'react-router-dom';

function DuplaSenaEstatistica() {
          ...
          .map((linha) =>
            linha
              ...
              .map((numero) => {
                ...
                return !isNaN(valor) && valor >= 1 && valor <= 50 ? valor : null;
              })
...
export default DuplaSenaEstatistica; 