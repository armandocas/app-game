...
import "./ConferirJogosQuina.css";

const ConferirJogosQuina = () => {
  ...
  const toggleNumberSelection = (number) => {
    ...
    if (selectedNumbers.includes(num)) {
      ...
      toast.error("Você só pode selecionar 5 números!", {
        position: "top-center",
        autoClose: 2000,
      });
    }
...
export default ConferirJogosQuina;
