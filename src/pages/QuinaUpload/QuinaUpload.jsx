...
function QuinaUpload() {
  ...
  const salvarJogosNoFirebase = async () => {
    ...
    try {
      for (const jogo of modalJogos) {
        await addDoc(collection(db, "quina-jogo-salvo"), {
          numeros: jogo,
  ...
  return (
    <div className="container quina-upload-container">
      <h1>Quina - Upload</h1>
