...
import "./GenerateSurpriseLotoMania.css";

const GenerateSurpriseLotoMania = () => {
  ...
  return (
    <div className="generate-surprise-container">
      <ToastContainer />
      <h1>Gerar Números em Modo Surpresa - LotoMania</h1>
...
export default GenerateSurpriseLotoMania;
