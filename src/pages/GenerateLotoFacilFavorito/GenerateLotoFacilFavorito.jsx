...
import "./GenerateLotoFacilFavorito.css";

const GenerateLotoFacilFavorito = () => {
  ...
  return (
    <div className="generate-numbers-container">
      <h1>Gerar Números LotoFácil com Preferências</h1>
...
export default GenerateLotoFacilFavorito;
