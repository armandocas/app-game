...
import './LotomaniaEstatistica.css';
import { Link } from 'react-router-dom';

function LotomaniaEstatistica() {
          ...
          .map((linha) =>
            linha
              ...
              .map((numero) => {
                ...
                return !isNaN(valor) && valor >= 0 && valor <= 99 ? valor : null; // Números entre 0 e 99
              })
...
export default LotomaniaEstatistica;
